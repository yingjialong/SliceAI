...
let package = Package(
    ...
    targets: [
        ...
        .testTarget(name: "SliceCoreTests",
                    ...
                    swiftSettings: swiftSettings),
        .testTarget(name: "OrchestrationTests",
                    dependencies: ["Orchestration", "SliceCore", "Capabilities", "LLMProviders"],
                    swiftSettings: swiftSettings),
        .testTarget(name: "CapabilitiesTests",
                    dependencies: ["Capabilities", "SliceCore"],
                    resources: [.copy("Fixtures")],
                    swiftSettings: swiftSettings),
